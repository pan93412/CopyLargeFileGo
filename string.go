/*
 * I18N 字串
 * for version: snapshot_20181015:1826(dev)
 */
 
package main

// 請勿修改此處。
const Version = "snapshot_20181015:1826(dev)"
...
// [過期] var Err_NotSupport = "目前所使用的系統：%s (%s) 不在支援行列中。提交 Pull Request 到：%s\n"

// 若目標位置已經有檔案。
var Err_dscExists = "目標位置已有檔案。"

// 若來源位置沒有檔案或資料夾。
var Err_srcNotExists = "來源位置沒有檔案或資料夾。"
